    ...
    return (
        <>
            ...
            <Alert variant="dark">
                ...
                <hr />
                <p className="mb-0">
                You may choose to seach multiple stocks at once, turning this area into a dashboard for your selected symbols. Deleting a symbol from the search bar will also remove the messages associated with it. 
                </p>
            </Alert>
            }
        </>
